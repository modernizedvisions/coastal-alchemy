...
import { ensureOrdersFulfillmentSchema, markOrderShippingLabelCreated } from '../../../../../_lib/orderFulfillment';
...
export async function onRequestPost(
  ...
  try {
    ...
    if (shipment.labelState === 'generated' || shipment.purchasedAt) {
      ...
      await markOrderShippingLabelCreated(context.env.DB, params.orderId);
